...
## The Paradox Rule (Core Foundation)
...
When an AI scores itself, it may **only** use externally documented, verifiable human observations (public statements, published prompts, recorded behavior, etc.). No credit for internal claims.
...
## Tighter Rubrics for Subjective Bricks (v1.4)
...
**Brick 21 – Self-Modification Capacity** (AI-only, does **not** affect main 20-brick score or tier)  
